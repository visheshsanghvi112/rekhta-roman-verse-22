  ...
  return (
    ...
    >
      <Link to={`/poem/${poem.id}`}>
        <Card className={`poetry-card overflow-hidden h-full border-rekhta-gold/10 shadow-sm hover:shadow-md transition-all duration-300 ${featured ? 'bg-gradient-to-br from-rekhta-cream to-rekhta-gold/10' : ''}`}>
          ...
          <CardFooter className="pt-2 border-t border-rekhta-gold/10">
            <div className="flex flex-wrap items-center gap-2 text-xs text-rekhta-brown/60">
